...
- `tests/conftest.py`: suite-wide fixture root above the `unit/`/`e2e/` split. `tests/unit/`: Mirrors `src/ansina/` 1:1. `tests/e2e/`: black-box, launches `python -m ansina` as a subprocess.
